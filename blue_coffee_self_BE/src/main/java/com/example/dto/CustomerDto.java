...
public class CustomerDto implements Validator {
    ...
    public CustomerDto(Integer id, String name, boolean isDelete, String dayOfBirth, Integer gender,
                       String idCard, String email, String address, String phoneNumber, User user) {
        this.id = id;
        this.name = name;
